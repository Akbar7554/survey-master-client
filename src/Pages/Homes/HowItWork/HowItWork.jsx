        ...
        <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-gray-900 group-hover:bg-gray-900">
              <RiMapPinUserFill className="text-2xl "></RiMapPinUserFill>
            </div>
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Enhance your profile by providing additional details, such as
                demographics and interests. This helps us match you with surveys
                that align with your background and preferences.
              </h4>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Browse the available surveys and choose the ones that interest
                you. Each survey will provide details such as estimated
          ...
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Start the survey by following the provided link. Carefully read
                and answer the questions. Your honest opinions are crucial for
                valuable insights.
              </h4>
            </div>
          </li>
          <li className="flex-start group relative flex lg:flex-col">
            ...
            <div className="ml-6 lg:ml-0 lg:mt-10">
              ...
              <h4 className="mt-2 text-base text-gray-700">
                Upon successful completion of a survey, you'll earn rewards.
                Rewards can vary and may include cash, gift cards, or other
                incentives. Check the survey details for information on your
                specific reward.
              </h4>
            </div>
          </li>
