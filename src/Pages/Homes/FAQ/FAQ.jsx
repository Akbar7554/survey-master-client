            ...
            <ul className="">
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  <div className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-[#2E3B55] text-white border-4 border-white text-xl font-semibold">
                    <svg
                      width="30px"
                      fill="white"
                      height="30px"
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-sky-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      The frequency of available surveys depends on our clients'
                      needs. New surveys are added regularly, so check back
                      often.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-[#2E3B55] text-white border-4 border-white text-xl font-semibold">
                    <svg
                      height="25px"
                      fill="white"
                      version="1.1"
              ...
              <li className="text-left mb-10">
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-sky-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      To participate in a survey, simply log in to your account
                      and browse the available surveys. Click on a survey to
                      begin.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-[#2E3B55] text-white border-4 border-white text-xl font-semibold">
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                    <h4 className="text-md leading-6 font-medium text-gray-900">
                      How can I provide feedback on a survey?
                    </h4>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-sky-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-sm">
                      We value your feedback! If you have suggestions or
                      encounter issues with a survey, please contact our support
                      team.
                    </p>
                  </div>
                  <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-[#2E3B55] text-white border-4 border-white text-xl font-semibold">
